...
30
```
add の型 Int -> Int -> Int は、引数としてInt と Int を受け取り、Int を返すという意味になります。（Haskellを知っている人にはいかにもカリー化されているように見えると思いますが、実際にはそうなっていません。）
...
```
リスト [2,4,2,1] をソートし、重複を取り除き、逆順にしたもの、と左から右へ自然な順で読めます。
